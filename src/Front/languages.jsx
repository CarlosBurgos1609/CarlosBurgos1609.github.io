      ...
      <section class="containers">
        <section class="languages">
          <h1>
            ...
            </picture> Lenguajes de programación<picture> <img src="https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/Programming_Languages.gif?raw=true" width="50px" /></picture>
          </h1>
          <div class="wrapper">
            <div class="slider-container">
              ...
              <div class="slider-item">
                {/* c# */}
                <a href="https://www.w3schools.com/cs/" target="_blank" rel="noreferrer"> <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/csharp/csharp-original.svg" alt="csharp" width="70" height="70"/> 
                </a>
              </div>
              <div class="slider-item">
                {/* java */}
        ...
        <section class="languages">
          <h1>
            <picture> <img src="https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/Programming_Languages.gif?raw=true" width="50px" />
            </picture> Desarrollo de Frontend y Backend<picture> <img src="https://github.com/7oSkaaa/7oSkaaa/blob/main/Images/Programming_Languages.gif?raw=true" width="50px" /></picture>
          </h1>
          <div class="wrapper">
            <div class="slider-container">
              <div class="slider-item">
